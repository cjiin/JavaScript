// 길이 체크, 하이픈이 있는지 체크해서 하이픈이 없으면 재입력 요구하도록
// 성별확인 123456-1234567
...
while(true) {
    ...
    if(jumin.length != 14) alert("입력오류 : 다시 입력해주세요.");
    else {
...
let genderStr; //화면에 성별을 출력하기 위한 문자열
...
const currYear = date.getFullYear(); //2023 네자리 연도 가져오기
